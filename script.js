...
const musica = new Audio('/sons/ambient-space-dream-meditation-background-music-149047.mp3')
...
//o paused  é uma propriedade do objeto audio que é um objeto nativo do javaScript
...
function alterarContexto(contexto) {
    ...
    startPauseBt.addEventListener('click', () => {
        if(intervaloId !== null) {
            ...
            audioPause.play()
            startPauseBt.textContent = "Retomar"
